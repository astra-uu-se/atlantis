...
class ConstraintSolver {
  public:
    ...
    // Constraints
    virtual void array_bool_and(const std::vector<ConstraintVarId>& inputs, ConstraintVarId reified) = 0;
    virtual void array_bool_and(const std::vector<ConstraintVarId>& inputs, bool shouldHold) = 0;
    ...
    virtual void array_bool_xor(const std::vector<ConstraintVarId>& inputs,
                        bool shouldHold) = 0;
    virtual void bool2int(ConstraintVarId boolVarId, ConstraintVarId intVarId) = 0;
    virtual void array_bool_element(const ConstraintVarId& index,
                            const std::vector<Int>& parameters,
                            ConstraintVarId output,
                            Int offset) = 0;
    virtual void array_bool_element2d(const ConstraintVarId& index1,
