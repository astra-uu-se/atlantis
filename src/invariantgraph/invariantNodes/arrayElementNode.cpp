...
void ArrayElementNode::registerOutputVars(propagation::SolverBase& solver, SolverMapping& mapping) const {
...
void ArrayElementNode::registerNode(propagation::SolverBase&, SolverMapping&) const {}
