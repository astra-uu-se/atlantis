...
void Bool2IntNode::registerOutputVars(propagation::SolverBase& solver, SolverMapping& mapping) const {
...
void Bool2IntNode::registerNode(propagation::SolverBase&, SolverMapping&) const {}
