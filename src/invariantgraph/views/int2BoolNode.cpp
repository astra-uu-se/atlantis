...
void Int2BoolNode::registerOutputVars(propagation::SolverBase& solver, SolverMapping& mapping) const {
...
void Int2BoolNode::registerNode(propagation::SolverBase&, SolverMapping&) const {}
