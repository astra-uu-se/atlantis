...
std::unique_ptr<invariantgraph::IntNeqNode>
invariantgraph::IntNeqNode::fromModelConstraint(
  ...
  auto node = std::make_unique<IntNeqNode>(a, b);
...
VarId invariantgraph::IntNeqNode::registerWithEngine(
