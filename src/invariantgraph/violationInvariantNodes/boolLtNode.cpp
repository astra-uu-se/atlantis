...
void BoolLtNode::registerOutputVars(propagation::SolverBase& solver, SolverMapping& mapping) const {
...
void BoolLtNode::registerNode(propagation::SolverBase& solver, SolverMapping& mapping) const {
