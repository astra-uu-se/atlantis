...
void CountLtNode::registerOutputVars(InvariantGraph& invariantGraph,
...
void CountLtNode::registerNode(InvariantGraph& invariantGraph, propagation::SolverBase& solver) {
