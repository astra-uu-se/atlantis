...
void ElementConst::init([[maybe_unused]] const Timestamp& t, Engine& e) {
  assert(m_id != NULL_ID);
...
void ElementConst::recompute(const Timestamp& t, Engine& e) {
  e.setValue(t, m_b, m_A.at(e.getValue(t, m_i)));
}

void ElementConst::notifyIntChanged(const Timestamp& t, Engine& e, LocalId,
