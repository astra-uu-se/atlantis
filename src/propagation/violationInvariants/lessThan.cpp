 ...
 */
LessThan::LessThan(SolverBase& solver, VarId violationId, VarViewId x,
                   VarViewId y)
    : ViolationInvariant(solver, violationId), _x(x), _y(y) {}

LessThan::LessThan(SolverBase& solver, VarViewId violationId, VarViewId x,
                   VarViewId y)
...
VarViewId LessThan::nextInput(Timestamp ts) {
