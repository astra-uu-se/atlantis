...
class ParTSPTW : public ::benchmark::Fixture {
 public:
...
std::vector<std::string> ParTSPTW::instances;

BENCHMARK_DEFINE_F(ParTSPTW, run)(::benchmark::State& st) {
...
BENCHMARK_REGISTER_F(ParTSPTW, run)
    ->Unit(::benchmark::kMillisecond)
    ->Apply(defaultArguments<ParTSPTW>)
    ->Iterations(1);
