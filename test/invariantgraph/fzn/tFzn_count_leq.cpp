...
class fzn_count_leqTest : public fzn_countTest {
 public:
  ...
  void generate() override {
    ...
    constraintIdentifier = isReified ? "fzn_count_leq_reif" : "fzn_count_leq";
    if (isReified) {
      addBoolArg(reified);
    } else {
...
RC_GTEST_FIXTURE_PROP(fzn_count_leqTest, RapidCheck, ()) { rapidCheck(); }
