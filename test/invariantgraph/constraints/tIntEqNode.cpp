  ...
  void SetUp() override {
    ...
    if constexpr (Type == ConstraintType::REIFIED) {
      _model->addConstraint(std::move(fznparser::Constraint(
          "int_eq_reif", std::vector<fznparser::Arg>{fznparser::IntArg{*a},
                                                     fznparser::IntArg{*b},
                                                     fznparser::BoolArg{*r}})));
      ...
      if constexpr (Type == ConstraintType::NORMAL) {
        _model->addConstraint(std::move(fznparser::Constraint(
            "int_eq", std::vector<fznparser::Arg>{fznparser::IntArg{*a},
                                                  fznparser::IntArg{*b}})));
      } else if constexpr (Type == ConstraintType::CONSTANT_FALSE) {
        _model->addConstraint(std::move(fznparser::Constraint(
            "int_eq_reif", std::vector<fznparser::Arg>{
    ...
    node = makeNode<invariantgraph::IntEqNode>(_model->constraints().front());
  }
