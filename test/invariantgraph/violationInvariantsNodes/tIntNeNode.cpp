...
class IntNeNodeTestFixture : public NodeTestBase<IntNeNode> {
 public:
...
TEST_P(IntNeNodeTestFixture, construction) {
...
TEST_P(IntNeNodeTestFixture, application) {
...
TEST_P(IntNeNodeTestFixture, propagation) {
...
INSTANTIATE_TEST_CASE_P(
    IntNeNodeTest, IntNeNodeTestFixture,
