...
class AbstractIntEqNodeTest : public NodeTestBase<IntEqNode> {
 public:
  VarNodeId a;
  VarNodeId b;
  VarNodeId r;
...
class IntEqNodeTest : public AbstractIntEqNodeTest<ViolationInvariantType::NORMAL> {};
...
class IntEqFalseNodeTest
    : public AbstractIntEqNodeTest<ViolationInvariantType::CONSTANT_FALSE> {};
