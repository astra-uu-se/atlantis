...
class ArrayBoolAndNodeTest
    : public AbstractArrayBoolAndNodeTest<ViolationInvariantType::NORMAL> {};
...
class ArrayBoolAndFalseNodeTest
    : public AbstractArrayBoolAndNodeTest<ViolationInvariantType::CONSTANT_FALSE> {};
...
class ArrayBoolAndTrueNodeTest
    : public AbstractArrayBoolAndNodeTest<ViolationInvariantType::CONSTANT_TRUE> {};
