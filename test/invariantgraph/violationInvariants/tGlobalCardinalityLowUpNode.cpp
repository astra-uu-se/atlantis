...
class GlobalCardinalityLowUpNodeTest
    : public AbstractGlobalCardinalityLowUpNodeTest<ViolationInvariantType::NORMAL> {};
...
class GlobalCardinalityLowUpReifNodeTest
    : public AbstractGlobalCardinalityLowUpNodeTest<ViolationInvariantType::REIFIED> {};
