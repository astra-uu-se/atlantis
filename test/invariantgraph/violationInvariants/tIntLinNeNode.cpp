...
class IntLinNeNodeTest
    : public AbstractIntLinNeNodeTest<ViolationInvariantType::NORMAL> {};
...
class IntLinNeReifNodeTest
    : public AbstractIntLinNeNodeTest<ViolationInvariantType::REIFIED> {};
...
class IntLinNeFalseNodeTest
    : public AbstractIntLinNeNodeTest<ViolationInvariantType::CONSTANT_FALSE> {};
...
class IntLinNeTrueNodeTest
    : public AbstractIntLinNeNodeTest<ViolationInvariantType::CONSTANT_TRUE> {};
