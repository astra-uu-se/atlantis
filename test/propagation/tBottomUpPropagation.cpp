...
TEST_F(BottomUpPropagationTest, RegisterVariableAndInvariant) {
  ...
  EXPECT_EQ(pg->getNumInvariants(), size_t(3));
...
TEST_F(BottomUpPropagationTest, SimplePropagate1) {
  ...
  EXPECT_EQ(e->getValue(v4), Int(0));
  EXPECT_EQ(e->getValue(v5), Int(0));
  EXPECT_EQ(e->getValue(v6), Int(0));
  ...
  EXPECT_EQ(e->getValue(v4), Int(3));
  EXPECT_EQ(e->getValue(v5), Int(6));
  EXPECT_EQ(e->getValue(v6), Int(12));
  ...
  for (size_t i = 0; i < 1000; ++i) {
    ...
    ASSERT_EQ(e->getValue(v5), Int(2) * (a + b + c));
    ASSERT_EQ(e->getValue(v6), Int(4) * (a + b + c));
  }
}
...
TEST_F(BottomUpPropagationTest, SimplePropagate2) {
  ...
  ASSERT_EQ(e->getValue(v13), Int(0));
...
TEST_F(BottomUpPropagationTest, QueryInput) {
  ...
  EXPECT_EQ(e->getValue(v1), Int(1));
  EXPECT_EQ(e->getValue(v2), Int(2));
  EXPECT_EQ(e->getValue(v3), Int(0));
}
...
TEST_F(BottomUpPropagationTest, SimpleCommit) {
  ...
  EXPECT_EQ(e->getCommittedValue(v1), Int(1));
  EXPECT_EQ(e->getCommittedValue(v2), Int(2));
  EXPECT_EQ(e->getCommittedValue(v3), Int(0));

  EXPECT_EQ(e->getCommittedValue(v6), Int(4 * (1 + 2 + 0)));
  ...
  EXPECT_EQ(e->getCommittedValue(v1), Int(0));
  EXPECT_EQ(e->getCommittedValue(v2), Int(0));
  EXPECT_EQ(e->getCommittedValue(v3), Int(0));

  EXPECT_EQ(e->getCommittedValue(v6), Int(0));
}
...
TEST_F(BottomUpPropagationTest, DynamicCommit) {
  ...
  ASSERT_EQ(e->getCommittedValue(output), Int(2 * 1));
  ...
  EXPECT_EQ(e->getCommittedValue(v3), Int(10));
  EXPECT_EQ(e->getCommittedValue(output), Int(2 * (1)));
  ...
  EXPECT_EQ(e->getCommittedValue(v3), Int(10));
  EXPECT_EQ(e->getCommittedValue(idx), Int(2));
  EXPECT_EQ(e->getCommittedValue(output), Int(2 * (10)));
}
...
TEST_F(BottomUpPropagationTest, DynamicCommit2) {
  ...
  ASSERT_EQ(e->getCommittedValue(output), Int(21));
  ...
  EXPECT_EQ(e->getCommittedValue(v32), Int(132));
  EXPECT_EQ(e->getCommittedValue(idx3), Int(1));
  EXPECT_EQ(e->getCommittedValue(output), Int(21));
  ...
  EXPECT_EQ(e->getCommittedValue(v32), Int(132));
  EXPECT_EQ(e->getCommittedValue(output), Int(132));
  ...
  EXPECT_EQ(e->getCommittedValue(output), Int(143));
}
