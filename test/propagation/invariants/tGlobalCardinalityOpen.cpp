...
class MockGlobalCardinalityOpen : public GlobalCardinalityOpen {
 public:
  ...
  explicit MockGlobalCardinalityOpen(Engine& engine,
                                     const std::vector<VarId>& outputs,
                                     const std::vector<VarId>& inputs,
                                     const std::vector<Int>& cover)
      : GlobalCardinalityOpen(engine, outputs, inputs, cover) {
...
TEST_F(GlobalCardinalityOpenTest, EngineIntegration) {
  for (const auto& [propMode, markingMode] : propMarkModes) {
    ...
    testNotifications<MockGlobalCardinalityOpen>(
        &engine->makeInvariant<MockGlobalCardinalityOpen>(*engine, outputs,
                                                          inputs, cover),
