...
class MockBoolXor : public BoolOr {
 public:
  ...
  explicit MockBoolXor(SolverBase& _solver, VarId outputId, VarId x, VarId y)
      : BoolOr(_solver, outputId, x, y) {
...
TEST_F(BoolXorTest, SolverIntegration) {
  for (const auto& [propMode, markingMode] : propMarkModes) {
    ...
    testNotifications<MockBoolXor>(
        &_solver->makeInvariant<MockBoolXor>(*_solver, output, x, y),
